...
package jp.co.ctc_g.jfw.web.util.internal;
 ...
 */
public final class WebUtilInternals {
    
    private WebUtilInternals() {}

    private static final String FRAMEWORK_RESOURCES_PROPERTIES = "jp.co.ctc_g.jfw.web.util.FrameworkResources";
    ...
    public static Config getConfig(Class<?> clazz) {
        ...
        try {
            ...
            throw new InternalException(WebUtilInternals.class, "E-INTERNAL#0001", m);
        }
    }
