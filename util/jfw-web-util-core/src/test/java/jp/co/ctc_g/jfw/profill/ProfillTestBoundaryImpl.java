...
public class ProfillTestBoundaryImpl implements ProfillTestBoundary {

    @Override
    public void invokeWithNonAnnotatedParameter(
    ...
    @Override
    public void invokeWithDefaultAnnotatedParameter(
            ProfillInterceptorIntegrationTestBean bean) {
    }
