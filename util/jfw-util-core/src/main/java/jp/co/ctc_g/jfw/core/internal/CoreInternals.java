 ...
 */
public final class CoreInternals {

    private CoreInternals() {}

    private static final String FRAMEWORK_RESOURCES_PROPERTIES = "jp.co.ctc_g.jfw.core.FrameworkResources";
    ...
    public static Config getConfig(Class<?> clazz) {
        ...
        try {
            ...
            throw new InternalException(CoreInternals.class, "E-INTERNAL#0001", m);
        }
    }
