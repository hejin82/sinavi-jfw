...
package jp.co.ctc_g.jse.core.internal;
 ...
 */
public final class WebCoreInternals {

    private WebCoreInternals() {}

    private static final String FRAMEWORK_RESOURCES_PROPERTIES = "jp.co.ctc_g.jse.core.FrameworkResources";
    ...
    public static Config getConfig(Class<?> clazz) {
        ...
        try {
            ...
            throw new InternalException(WebCoreInternals.class, "E-INTERNAL#0001", m);
        }
    }
