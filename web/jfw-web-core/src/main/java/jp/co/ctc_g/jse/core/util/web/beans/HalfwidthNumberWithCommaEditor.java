 ...
 * このクラスは、正規表現 {@code ^[-－]?([0０]|([1-9１-９][0-9０-９]{0,2}([,，][0-9０-９]{3})*))$} に従った
 * 半角カンマ区切りの整数値を扱うことができます。
 * </p>
 ...
 */
public class HalfwidthNumberWithCommaEditor extends AbstractNumberEditor {

    private static final String PATTERN_STR = "^[-]?([0]|([1-9][0-9]{0,2}([,，][0-9]{3})*))$";
     ...
     * デフォルトコンストラクタです。
     */
    public HalfwidthNumberWithCommaEditor() {}
     ...
     */
    public HalfwidthNumberWithCommaEditor(Class<? extends Number> propertyType,
    ...
    public HalfwidthNumberWithCommaEditor(Class<? extends Number> propertyType,
        ...
        if (propertyType == null) {
            throw new InternalException(HalfwidthNumberWithCommaEditor.class, "E-NUMBER_EDITOR#0001");
        }
