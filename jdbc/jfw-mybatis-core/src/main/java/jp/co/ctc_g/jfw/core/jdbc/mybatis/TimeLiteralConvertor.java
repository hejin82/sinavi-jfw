...
/**
 * <p>
 * {@link java.sql.Time}型のパラメータをリテラル文字列に変換します。
 * </p>
 * <h3>変換内容</h3>
 * <p>
 * JDBC 時間エスケープ形式 {@code hh:mm:ss} で{@code String}型に変換し、
 * シングルクォーテーションによって囲まれた文字列をリテラル文字列として返却します。
 * </p>
 */
public class TimeLiteralConvertor implements LiteralConvertor<Time> {
     ...
     */
    @Override
    public String convert(Time target) {
        checkNotNull(target);
