...
/**
 * <p>
 * {@link java.sql.Date}型のパラメータをリテラル文字列に変換します。
 * </p>
 * <h3>変換内容</h3>
 * <p>
 * 日付エスケープ形式 {@code yyyy-mm-dd} で{@code String}型に変換し、
 * シングルクォーテーションによって囲まれた文字列をリテラル文字列として返却します。
 * </p>
 */
public class SqlDateLiteralConvertor implements LiteralConvertor<Date> {
     ...
     * デフォルトコンストラクタです。
     */
    public SqlDateLiteralConvertor() {}
