...
/**
 * <p>
 * このクラスは、{@link NotAllowedException}の例外ハンドラです。
 * </p>
 * <p>
 * 処理中に{@link NotAllowedException}が発生した場合は、
 * このハンドラが例外を補捉し、
 * クライアントへJSON形式で以下の例外メッセージを返します。
 * <pre class="brush:java">
 * {
 *  "status": 405,
 *  "code": "W-REST-CLIENT#405",
...
public class NotAllowedExceptionMapper implements ExceptionMapper<NotAllowedException> {
    ...
    private static final Logger L = LoggerFactory.getLogger(NotAllowedExceptionMapper.class);
    private static final ResourceBundle R = InternalMessages.getBundle(NotAllowedExceptionMapper.class);
