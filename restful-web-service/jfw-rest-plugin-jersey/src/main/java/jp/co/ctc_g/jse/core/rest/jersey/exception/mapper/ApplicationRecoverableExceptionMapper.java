...
/**
 * <p>
 * このクラスは、{@link ApplicationRecoverableException}の例外ハンドラです。
 * </p>
 * <p>
 * 処理中に{@link ApplicationRecoverableException}が発生した場合は、
 * このハンドラが例外を捕捉し、
 * クライアントへJSON形式で以下の例外メッセージを返します。
 * <pre class="brush:java">
 * {
 *  "status": 400,
 *  "code": "W-APP-ERROR-CODE#001",
 *  "message": "アプリケーション回復可能例外が発生しました。"
 * }
 * </pre>
 * </p>
 * <p>
...
public class ApplicationRecoverableExceptionMapper implements ExceptionMapper<ApplicationRecoverableException> {
     ...
     * デフォルトコンストラクタです。
     */
    public ApplicationRecoverableExceptionMapper() {}

    /**
     * {@inheritDoc}
     */
    @Override
    public Response toResponse(ApplicationRecoverableException exception) {
        if (L.isDebugEnabled()) {
