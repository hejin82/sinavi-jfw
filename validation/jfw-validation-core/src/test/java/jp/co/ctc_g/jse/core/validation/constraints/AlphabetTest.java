...
public class AlphabetTest {
    ...
    public static class CharSequenceAlphabetTest {
        ...
        public void invalid(String invalid) {
            ...
            Set<ConstraintViolation<AlphabetTargetBean>> errors = VALIDATOR.validate(target);
    ...
    public static class ObjectAlphabetTest {
    ...
    public static class MessageTest {
        ...
        public void override_message_test(String invalid) {
            ...
            class AlphabetTargetBean {
                ...
                @Alphabet(message = "半角アルファベットのみ入力可能です。${validatedValue}")
                public String value;
            }
            AlphabetTargetBean target = new AlphabetTargetBean();
            target.value = invalid;
            ...
            assertThat(errors, notNullValue());
            assertThat(errors.size(), is(1));
            assertEqualsErrorMessages(errors, "半角アルファベットのみ入力可能です。" + invalid);
        }
