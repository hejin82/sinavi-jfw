...
public class HalfwidthKatakanaTest {

    protected static Validator VALIDATOR;

    @RunWith(Theories.class)
    public static class CharSequenceHalfwidthKatakanaTest {

        @DataPoints
        public static final String[] VALIDS = {
            null, "", "ｱ", "ｲｳｴｵｶｷｸｹｺｻｼｽｾｿﾀﾁﾂﾃﾄﾅﾆﾇﾈﾉﾊﾋﾌﾍﾎﾏﾐﾑﾒﾓﾔﾕﾖﾗﾘﾙﾚﾛﾜｦﾝﾞﾟｧｨｩｪｫｬｭｮｯ"
        };
        ...
        public void invalid(String invalid) {
            ...
            Set<ConstraintViolation<HalfwidthKatakanaTargetBean>> errors = VALIDATOR.validate(target);
    ...
    public static class ObjectHalfwidthKatakanaTest {
    ...
    public static class MessageTest {
        ...
        public void invalid(String invalid) {
            ...
            assertThat(errors, notNullValue());
            assertThat(errors.size(), is(1));
            assertEqualsErrorMessages(errors, "半角カタカナで入力してください。");
        }
        ...
        public void override_message_test(String invalid) {
            ...
            class HalfwidthKatakanaTargetBean {
                ...
                @HalfwidthKatakana(message = "半角カナのみ入力可能です。${validatedValue}")
                public String value;
            }
            HalfwidthKatakanaTargetBean target = new HalfwidthKatakanaTargetBean();
            target.value = invalid;
            ...
            assertThat(errors, notNullValue());
            assertThat(errors.size(), is(1));
            assertEqualsErrorMessages(errors, "半角カナのみ入力可能です。" + invalid);
        }
