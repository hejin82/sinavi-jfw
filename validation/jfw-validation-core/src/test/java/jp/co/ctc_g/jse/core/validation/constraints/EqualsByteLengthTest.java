...
public class EqualsByteLengthTest {
    ...
    public static class CharSequenceEqualsByteLengthTest {
        ...
        public static final String[] VALIDS = {
            null, "", "123456789012345", "abcdefghijklmno", "ABCDEFGHIJKLMNO", "ＡＢＣＤＥ", "アイウエオ", "ｱｲｳｴｵ", "亜衣兎絵御"
        };
        ...
        public static final String[] SJIS_VALIDS = {
            null, "", "1234567890", "abcdefghij", "ABCDEFGHIJ", "ＡＢＣＤＥ", "アイウエオ", "ｱｲｳｴｵｶｷｸｹｺ", "亜衣兎絵御"
        };
        ...
        public void valid(String valid) throws UnsupportedEncodingException {
            ...
            target.value = valid;
            Set<ConstraintViolation<EqualsByteLengthTargetBean>> errors = VALIDATOR.validate(target);
        ...
        public void validShiftJIS(String valid) {
            ...
            class EqualsByteLengthTargetBean {
                ...
                @EqualsByteLength(value = 10, encoding = "Shift_JIS")
                public String value;
            }
            EqualsByteLengthTargetBean target = new EqualsByteLengthTargetBean();
            target.value = valid;
    ...
    public static class MessageTest {
        ...
        public void default_message_test(String invalid) {
            ...
            assertThat(errors, notNullValue());
            assertThat(errors.size(), is(1));
            assertEqualsErrorMessages(errors, "15バイト長で入力してください。");
        }
        ...
        public void override_message_test(String invalid) {
            ...
            class EqualsByteLengthTargetBean {
                ...
                @EqualsByteLength(value = 15, message = "入力可能なバイト数を超えています。最大:{value}${validatedValue}")
                public String value;
            }
            EqualsByteLengthTargetBean target = new EqualsByteLengthTargetBean();
            target.value = invalid;
