...
public class ZenkakuTest {
    ...
    public static class CharSequenceZenkakuTest {
        ...
        public static final String[] VALIDS = {
            ...
            "①②③④⑤⑥⑦⑧⑨⑩⑪⑫⑬⑭⑮⑯⑰⑱⑲⑳", "！”＃＄％＆’（）＝￣｜‘｛＋＊｝＜＞？＿－＾￥￥＠［；：］．／", "アイウエオカキクケコサシスセソタチツテトナニヌネノハヒフヘホマミムメモヤユヨラリルレロワヲン",
            "ガギグゲゴザジズゼゾダヂヅデドバビブベボパピプペポァィゥェォャュョッ", "Здравствуйте", "ａｂｃｄｅｆｇｈｉｊｋｌｍｎｏｐｑｒｓｔｕｖｗｘｙｚＡＢＣＤＥＦＧＨＩＪＫＬＭＮＯＰＱＲＳＴＵＶＷＸＹＺ",
            "０１２３４５６７８９", "ゐ", "ゑ", "ゔ"
        };
        ...
        public static final String[] INVALIDS = {
            ...
            "καλημέρασας", "สวัสดี", "你好", "ｱｲｳｴｵｶｷｸｹｺｻｼｽｾｿﾀﾁﾂﾃﾄﾅﾆﾇﾈﾉﾊﾋﾌﾍﾎﾏﾐﾑﾒﾓﾔﾕﾖﾗﾘﾙﾚﾛﾜｦﾝﾞﾟｧｨｩｪｫｬｭｮｯ", " 　\t", "\n\r"
        };
        ...
        public void invalid(String invalid) {
            ...
            Set<ConstraintViolation<ZenkakuTargetBean>> errors = VALIDATOR.validate(target);
    ...
    public static class ObjectZenkakuTest {
    ...
    public static class MessageTest {
        ...
        public void default_message_test(String invalid) {
            ...
            assertThat(errors, notNullValue());
            assertThat(errors.size(), is(1));
            assertEqualsErrorMessages(errors, "全角文字列で入力してください。");
        }
        ...
        public void override_message_test(String invalid) {
            ...
            class ZenkakuTargetBean {
                ...
                @Zenkaku(message = "全角文字列のみ入力可能です。${validatedValue}")
                public String value;
            }
            ZenkakuTargetBean target = new ZenkakuTargetBean();
            target.value = invalid;
            ...
            assertThat(errors, notNullValue());
            assertThat(errors.size(), is(1));
            assertEqualsErrorMessages(errors, "全角文字列のみ入力可能です。" + invalid);
        }
