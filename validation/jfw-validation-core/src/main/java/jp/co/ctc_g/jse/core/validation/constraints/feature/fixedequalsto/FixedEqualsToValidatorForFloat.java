 ...
 * @see FixedEqualsTo
 */
public class FixedEqualsToValidatorForFloat implements ConstraintValidator<FixedEqualsTo, Float> {
     ...
     * デフォルトコンストラクタです。
     */
    public FixedEqualsToValidatorForFloat() {}
    ...
    public void initialize(FixedEqualsTo constraint) {
        try {
            this.value = Float.valueOf(constraint.value());
     ...
     */
    @Override
    public boolean isValid(Float suspect, ConstraintValidatorContext context) {
