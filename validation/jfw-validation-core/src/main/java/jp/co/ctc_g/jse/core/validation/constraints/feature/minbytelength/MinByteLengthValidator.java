...
/**
 * <p>
 * このクラスは、{@link MinByteLength}バリデータの検証アルゴリズムを実装しています。
 * </p>
 * <p>
 * {@link MinByteLength}バリデータの検証アルゴリズムは、検証対象の文字列を指定された文字コードでエンコードし、バイト配列を取得します。
 * 取得したバイト配列の長さが指定されたバイト長以上かどうかを検証します。
 * </p>
...
public class MinByteLengthValidator implements ConstraintValidator<MinByteLength, CharSequence> {
     ...
     * デフォルトコンストラクタです。
     */
    public MinByteLengthValidator() {}

    /**
     * {@inheritDoc}
     */
    @Override
    public void initialize(MinByteLength constraint) {
