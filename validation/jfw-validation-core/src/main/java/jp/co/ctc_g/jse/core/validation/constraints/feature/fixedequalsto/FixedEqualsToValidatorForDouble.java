 ...
 * @see FixedEqualsTo
 */
public class FixedEqualsToValidatorForDouble implements ConstraintValidator<FixedEqualsTo, Double> {
     ...
     * デフォルトコンストラクタです。
     */
    public FixedEqualsToValidatorForDouble() {}
    ...
    public void initialize(FixedEqualsTo constraint) {
        try {
            this.value = Double.valueOf(constraint.value());
     ...
     */
    @Override
    public boolean isValid(Double suspect, ConstraintValidatorContext context) {
