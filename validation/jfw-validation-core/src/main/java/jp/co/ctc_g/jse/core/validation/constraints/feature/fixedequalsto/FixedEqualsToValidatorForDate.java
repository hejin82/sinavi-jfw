 ...
 * @see FixedEqualsTo
 */
public class FixedEqualsToValidatorForDate implements ConstraintValidator<FixedEqualsTo, Date> {
     ...
     * デフォルトコンストラクタです。
     */
    public FixedEqualsToValidatorForDate() {}
    ...
    public void initialize(FixedEqualsTo constraint) {
        try {
            SimpleDateFormat sdf = new SimpleDateFormat(constraint.datePattern());
            this.value = sdf.parse(constraint.value());
