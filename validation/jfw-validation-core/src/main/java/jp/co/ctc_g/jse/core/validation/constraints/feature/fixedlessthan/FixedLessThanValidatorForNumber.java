 ...
 * @see FixedLessThan
 */
public class FixedLessThanValidatorForNumber implements ConstraintValidator<FixedLessThan, Number> {
     ...
     * デフォルトコンストラクタです。
     */
    public FixedLessThanValidatorForNumber() {}
    ...
    public boolean isValid(Number suspect, ConstraintValidatorContext context) {
        ...
        return Validators.lessThan(suspect, target);
    }
}
