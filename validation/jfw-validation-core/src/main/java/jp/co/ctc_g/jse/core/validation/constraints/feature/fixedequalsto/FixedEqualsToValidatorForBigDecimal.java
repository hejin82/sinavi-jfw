 ...
 * @see FixedEqualsTo
 */
public class FixedEqualsToValidatorForBigDecimal implements ConstraintValidator<FixedEqualsTo, BigDecimal> {
     ...
     * デフォルトコンストラクタです。
     */
    public FixedEqualsToValidatorForBigDecimal() {}
    ...
    public void initialize(FixedEqualsTo constraint) {
        try {
            this.value = new BigDecimal(constraint.value());
     ...
     */
    @Override
    public boolean isValid(BigDecimal suspect, ConstraintValidatorContext context) {
