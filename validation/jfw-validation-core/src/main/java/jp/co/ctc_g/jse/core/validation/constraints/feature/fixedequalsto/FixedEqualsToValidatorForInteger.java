...
public class FixedEqualsToValidatorForInteger implements ConstraintValidator<FixedEqualsTo, Integer> {
     ...
     * デフォルトコンストラクタです。
     */
    public FixedEqualsToValidatorForInteger() {}
    ...
    public void initialize(FixedEqualsTo constraint) {
        try {
            this.value = Integer.valueOf(constraint.value());
     ...
     */
    @Override
    public boolean isValid(Integer suspect, ConstraintValidatorContext context) {
